 ...
 *
 * Page d'inscription de Dixipolis — version liste d'attente.
 *
 * La création de compte n'est pas encore ouverte : plutôt qu'un faux
 * formulaire d'inscription, cette page l'annonce honnêtement et propose de
 * rejoindre la liste d'attente (WaitlistForm → POST /api/waitlist,
 * source "inscription").
 *
 * Contenu :
...
export default function InscriptionPage() {
  return (
    ...
    >
      {/* ================================================================
       * Carte centrale
       * max-w-md pour une largeur confortable, identique à la connexion.
       * ================================================================ */}
      <div
      ...
      >
        ...
        <div className="mb-6 text-center">
          ...
          >
            La cr&eacute;ation de compte n&apos;est pas encore disponible.
            Laissez votre email pour &ecirc;tre pr&eacute;venu d&egrave;s
            l&apos;ouverture.
          </p>
        </div>
         ...
         * Formulaire de liste d'attente
         * ================================================================ */}
        <WaitlistForm source="inscription" />
