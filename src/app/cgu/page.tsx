 ...
 *
 * Sections :
 *   1. Objet               — Finalite du document
 *   2. Definitions          — Vocabulaire employe dans les CGU
 *   3. Acces au service     — Conditions d'inscription et d'utilisation
 *   4. Description du service — Fonctionnalites proposees
 *   5. Propriete intellectuelle — Droits sur le contenu et la plateforme
 *   6. Responsabilites de l'utilisateur — Obligations et interdictions
 *   7. Responsabilite de Dixipolis — Limitation de responsabilite
 *   8. Donnees personnelles — Renvoi vers la politique de confidentialite
 *   9. Modification des CGU — Procedure de mise a jour
 *  10. Resiliation          — Conditions de fermeture de compte
 *  11. Droit applicable et litiges — Juridiction competente
 *  12. Contact              — Coordonnees pour les questions
 *
 * Conventions :
    ...
    <PageWrapper className="py-12 md:py-16 lg:py-20">
      ...
      <div className="card p-6 sm:p-8 md:p-10 lg:p-12 max-w-4xl mx-auto">
        ...
        <section className="mb-8 pb-8 border-b border-[var(--color-border)]">
          ...
          <div className="space-y-3 text-sm text-[var(--color-text-secondary)] leading-relaxed">
            ...
            <ul className="list-disc pl-5 space-y-2 mt-3">
              ...
              <li>
                <strong className="text-[var(--color-text-primary)]">&quot;Service&quot; :</strong>{" "}
              ...
              <li>
                <strong className="text-[var(--color-text-primary)]">&quot;Editeur&quot; :</strong>{" "}
        ...
        <section className="mb-8 pb-8 border-b border-[var(--color-border)]">
          ...
          <div className="space-y-3 text-sm text-[var(--color-text-secondary)] leading-relaxed">
            <h3 className="text-base font-semibold text-[var(--color-text-primary)] mt-2 mb-2">
         ...
         * Renvoi vers la politique de confidentialite dediee.
         * ---------------------------------------------------------------- */}
        <section className="mb-8 pb-8 border-b border-[var(--color-border)]">
          <h2 className="text-xl font-bold text-[var(--color-text-primary)] mb-4">
